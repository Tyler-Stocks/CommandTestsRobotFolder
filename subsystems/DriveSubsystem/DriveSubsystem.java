...
public class DriveSubsystem extends SubsystemBase {
  ...
  private static double[] m_driveFTheta= new double[1];
//The motors on the right side of the drive.
  ...
  private final DifferentialDrive DiffDrive = new DifferentialDrive(MotorLeft1::set,MotorRight1::set);
  ...
  public void initialize(){
    ...
    MotorLeft1.addFollower(MotorLeft2);
    MotorRight1.addFollower(MotorRight2);
  }
...
/**
   ...
   */
  public Command arcadeDriveSquaredCommand(DoubleSupplier fwd, DoubleSupplier rot) {
  ...
  public Command arcadeDriveAdaptiveSteeringCommand(DoubleSupplier fwd, DoubleSupplier rot) {
    // A split-stick arcade command, with forward/backward controlled by the left
    // hand, and turning controlled by the right.
